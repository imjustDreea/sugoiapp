...
const Sidebar = () => {
  ...
  return (
    <aside className={`${containerWidth} bg-darkPanel p-2 sm:p-4 md:p-6 flex flex-col justify-between transition-all duration-200 relative`}>
      <div>
    ...
    <div className={`absolute bottom-4 ${collapsed ? '-right-3' : '-right-6'} transition-all`}>
        <button
